...
from inference.logger import InferenceLogger

UPLOAD_FOLDER = "uploads"
ALLOWED = {"png", "jpg", "jpeg"}
MODEL_MAP = {
    "resnet50": "models/final/resnet50_final.pth", 
    "resnet101": "models/final/resnet101_final.pth"
}
...
def index():
    ...
    inference_logger = InferenceLogger(session_id)
